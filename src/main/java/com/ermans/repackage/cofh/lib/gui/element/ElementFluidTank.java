...
public class ElementFluidTank extends ElementBase {
    ...
    public static final ResourceLocation DEFAULT_TEXTURE = new ResourceLocation(Textures.Gui.Element.FLUID_TANK);
    public static final int DEFAULT_POSX = 150;
    public static final int DEFAULT_POSY = 9;
    ...
    public ElementFluidTank(GuiBase gui, IFluidTank tank) {
        this(gui, DEFAULT_POSX, DEFAULT_POSY, tank);
    }
