package com.ermans.repackage.cofh.lib.render.particle;
...
public class EntityDropParticleFX extends EntityFX {
    ...
    public void onUpdate() {
        ...
        if (this.particleGravity > 0) {
            IBlockState blockState = this.worldObj.getBlockState(new BlockPos(MathHelper.floor(this.posX), MathHelper.floor(this.posY), MathHelper.floor(this.posZ)));
...
//                        MathHelper.floor(this.posZ)));
                ...
                double d0 = MathHelper.floor(this.posY) + 1 - BlockLiquid.getLiquidHeightPercent(blockState.getBlock().getMetaFromState(blockState));
            ...
            IBlockState blockState = this.worldObj.getBlockState(new BlockPos(MathHelper.ceil(this.posX), MathHelper.ceil(this.posY), MathHelper.ceil(this.posZ)));
            Material material = blockState.getBlock().getMaterial();

            if (material.isLiquid() || material.isSolid()) {
                double d0 = MathHelper.ceil(this.posY) + 1 - BlockLiquid.getLiquidHeightPercent(blockState.getBlock().getMetaFromState(blockState));
                if (this.posY > d0) {
                    this.setDead();
                }
            }
